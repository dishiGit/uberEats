                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.html">Uber Eats</a>
                ...
                <span class="icon-menu"></span>
                    ...
                    <span class="icon-arrow-down"></span> 
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            <a class="dropdown-item" href="account.php?id=<?=$_GET["id"]?>" >Account</a>
                                            <a class="dropdown-item" href="#">Setting</a>
                                            <a class="dropdown-item" href="orderHistory.php?id=<?=$_GET["id"]?>">Order history</a>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="index.html">Log out</a>
                                    </li>
                                    <li><a href="displayAll.php" class="btn btn-outline-light top-btn"><span class="ti-plus"></span> Click Me</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    <h1>Discover great restaurants in Montreal</h1>
                            ...
                            <div class="col-md-10">
                                <form class="form-wrap mt-4">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <input type="text" placeholder="Montreal" class="btn-group2">
